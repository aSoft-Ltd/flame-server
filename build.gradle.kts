...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/flame")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/flame/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/flame/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/flame.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/flame.git")
            }
        }
    }
}